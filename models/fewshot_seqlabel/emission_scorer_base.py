#!/usr/bin/env python
import torch
from models.fewshot_seqlabel.similarity_scorer_base import SimilarityScorerBase, MatchingSimilarityScorer, \
    PrototypeSimilarityScorer, ProtoWithLabelSimilarityScorer
from models.fewshot_seqlabel.scale_controller import ScaleControllerBase
